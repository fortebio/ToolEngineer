 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --no-kerning --bpp 4 --size 72 --font /System/Library/Fonts/Supplemental/Arial Bold.ttf --symbols 0123456789: --format lvgl --lv-font-name lv_font_countdown_72 -o firmware-vimate/main/ui/fonts/lv_font_countdown_72.c
 ******************************************************************************/

#include "lvgl.h"

#ifndef LV_FONT_COUNTDOWN_72
#define LV_FONT_COUNTDOWN_72 1
#endif

#if LV_FONT_COUNTDOWN_72
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_countdown_72 = {
#else
lv_font_t lv_font_countdown_72 = {
#endif
