...
typedef enum {
    JPEG_TO_IMAGE_RGB565 = 0,
    JPEG_TO_IMAGE_RGB888 = 1,
} jpeg_to_image_format_t;

/**
 * @brief Decodes a JPEG image from memory to raw pixel data
 *
 ...
 *       - jpeg_to_image() keeps the legacy RGB565 output.
 *       - jpeg_to_image_ex() can output RGB565 or RGB888.
 *
