# Forte Rapid4P — firmware (RAPID READER 4 SLOT)

Thiết bị đọc test nhanh 4 ống cùng lúc (TCS34725 ×4 sau mux TCA9548A), màn cảm ứng 4,3",
...
**Phiên bản:** `v0.1.0` (`main/rapid4p.h`) · ESP-IDF 5.5.1 · target `esp32p4` · **chưa nạp máy thật**.

## Luồng người dùng

```
START ─ĐO─► Chọn mẫu (Tôm thẻ/Tôm sú/Cá rô phi/Heo/Nước) ─► Chọn bệnh (PC/EHP/EMS/WSSV/TPD)
      ─► Đặt ống vào 4 khe ─ĐO─► Đang đo (3 vòng × 4 khe, ~34 s) ─► Kết quả 4 khe (0–3000, +/−)
START ─► Cân chỉnh: mỗi khe đọc Cao nhất rồi Thấp nhất → NVS (4 khe)
