                  ...
                  C(e, function (i, d) {
                    if (!n && s && s.indexOf(d) > -1 && r[d]) {
                      ...
                      l(i, !0) && !i.nodeType
                        ? ((o[d] = h(i) ? [] : {}),
                          t(i, r[d] || {}, o[d], n + 1),
                          0 !== Object.keys(o[d]).length ||
                            ("colorAxis" === d && 0 === n) ||
                            delete o[d])
                        : (e[d] !== r[d] || (d in e && !(d in r))) &&
                          "__proto__" !== d &&
                          "constructor" !== d &&
                          (o[d] = a[d]);
                  });
        ...
        function (t, e) {
          ...
          class m {
            ...
            getTimeTicks(t, e, i, r) {
              ...
              return (
                (g.info = o(t, { higherRanks: f, totalRange: x * y })),
                g
              );
            }
            ...
            constructor(t, e, i, s, r, o, n) {
              ...
              (n || l.css(this.getStyle(s || {})),
                ...
                this.createElement("desc")
                  .add()
                  .element.appendChild(
                    g.createTextNode("Created with Highcharts 11.4.8"),
                  ),
            ...
            getReferenceURL() {
              if ((f || x) && g.getElementsByTagName("base").length) {
                if (!A(d)) {
                  ...
                  T(i, { position: "fixed", top: 0, left: 0, zIndex: 9e5 });
          ...
          class N {
            ...
            init(t, e, i = this.coll) {
              ...
              (this.type ?? (this.type = o.type || "linear"),
                ...
                (this.hasNames =
                  "category" === this.type || !0 === o.categories),
                (this.categories =
            ...
            getTitlePosition(t) {
              ...
              return (
                k(this, "afterGetTitlePosition", { titlePosition: f }),
                f
              );
            }
            renderMinorTick(t, e) {
            ...
            (function (t) {
              function e() {
                "logarithmic" !== this.type
                  ...
                  : (this.logarithmic ?? (this.logarithmic = new n(this)));
              }
              function o() {
                let t = this.logarithmic;
                t &&
          ...
          class p {
            ...
            render() {
              ...
              if (
                ...
                (p.zIndex = a),
                (A += "-" + a),
                (C = t.plotLinesAndBandsGroups[A]) ||
                  (t.plotLinesAndBandsGroups[A] = C =
                    u
                      .g("plot-" + A)
                      .attr(p)
                      .add()),
            ...
            renderLabel(t, e, i, n) {
              ...
              c ||
                ((this.label = c =
                  h.text(this.getLabelText(t), 0, 0, t.useHTML).attr({
              ...
              let p = e.xBounds || [e[0][1], e[1][1], i ? e[2][1] : e[0][1]],
                ...
                f = r(u),
                m = s(p) - g;
              (c.align(t, !1, { x: g, y: f, width: m, height: s(u) - f }),
                (!c.alignValue || "left" === c.alignValue || o(d)) &&
                  c.css({
                    width:
                      (t.style?.width ||
                        (i && d
                          ? m
                          : 90 === c.rotation
                            ? a.height - (c.alignAttr.y - a.top)
                            : (t.clip ? a.width : a.chart.chartWidth) -
                              (c.alignAttr.x - a.left))) + "px",
                  }),
                c.show(!0));
            }
            getLabelText(t) {
        ...
        function (t, e, i, s, r, o) {
          ...
          class A {
              ...
              if (!this.label) {
                if (this.outside) {
                  ...
                  ((this.container = h = i.doc.createElement("div")),
                    ...
                    (this.renderer = l =
                      new e(h, 0, 0, t, void 0, void 0, l.styledMode)));
                }
                if (
                  (a
                ...
                this.label.attr({ zIndex: 8 }).shadow(n.shadow).add();
              }
              return (
                h && !h.parentElement && i.doc.body.appendChild(h),
                this.label
              );
            }
            getPlayingField() {
            ...
            refresh(t, e) {
              ...
              (n && this.allowShared
                ? (r.applyInactiveState(a),
                  ...
                  ((f = l.getLabelConfig()).points = d))
                : (f = l.getLabelConfig()),
                (this.len = d.length));
              let M = S(c) ? h(c, f, i) : p.call(f, this),
                T = l.series;
              if (
                ((this.distance = k(T.tooltipOptions.distance, 16)), !1 === M)
              )
                this.hide();
              else {
                      ...
                      this.outside &&
                        t.attr({
                          x: g(
                            t.x || 0,
                            0,
                            this.getPlayingField().width - (t.width || 0),
                          ),
                        }),
                      u ||
                        t.attr({
                          stroke:
                            s.borderColor || l.color || T.color || "#666666",
                        }),
                      this.updatePosition({
                        plotX: v,
                        plotY: C,
            ...
            renderSplit(t, e) {
              ...
              c && T.attr({ opacity: 1 === T.opacity ? 0.999 : 1 });
            }
            drawTracker() {
            ...
            setDOMEvents() {
              ...
              ((t.onmousedown = this.onContainerMouseDown.bind(this)),
                ...
                S.unbindDocumentMouseUp.push(
                  h(e, "mouseup", this.onDocumentMouseUp.bind(this)),
                ));
            ...
            (function (t) {
              function e(t, e, o) {
                let n = (this.legendItem = this.legendItem || {}),
                  ...
                  g = a.renderer,
                  f = n.group,
                  m = l - Math.round((t.fontMetrics?.b || c) * (o ? 0.4 : 0.3)),
                  x = {},
                  y,
                  b = h.marker,
                  v = 0;
        ...
        function (t, e, i, s, r, o, n, a, h, l) {
          ...
          class X {
            ...
            getProcessedData(t) {
              ...
              let m = O(
                [r ? p.map(r.log2lin) : p],
                () => e.requireSorting && !g && T(15, !1, e.chart),
              );
              return {
                xData: p,
                yData: u,
          ...
          class Q {
            ...
            getChartSize() {
              ...
              ((this.chartWidth = Math.max(0, e || s.width || 600)),
                (this.chartHeight = Math.max(
                  0,
                  Z(i, this.chartWidth) || (r ? s.height : 400),
                )),
                (this.containerBox = s));
            }
            temporaryDisplay(t) {
            ...
            transform(t) {
              ...
              e)) {
                ...
                if (
                  ...
                  for (let e of t.series) {
                    ...
                    (T ??
                      ...
                      H(t.dataMin) &&
                        H(t.dataMax) &&
                        ((T.dataMin = Math.min(t.dataMin, T.dataMin)),
                ...
                (!t.isOrdinal || t.options.overscroll || 1 !== v || r) &&
                  (M < G && ((M = G), v >= 1 && (w = M + j)),
                  w > X && ((w = X), v >= 1 && (M = w - j)),
                  (r ||
                    (t.series.length &&
              ...
              (i.pointPadding && (S = Math.ceil(S)),
                ...
                t.points.forEach(function (s) {
                  ...
                  (l &&
                    ...
                    i.centerInCategory &&
                      !i.stacking &&
                      (A = t.adjustForMissingColumns(A, T, s, c)),
                    (s.barX = A),
                    (s.pointWidth = T),
