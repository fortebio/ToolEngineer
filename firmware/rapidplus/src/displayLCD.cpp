...
{
  {
    ...
    for (u8_t i = 0; i < OPTOCHANNELS; i++)
    {
      ...
      else
      {
        ...
        {
          // Re-enabled on v2.4.5at: cf6e66e commented this out, but the DEFAULT env
          // (esp32dev) is the build that PRODUCES F, and the early-rise change routes
          // more wells here. Shipping that with this branch commented would put the
          // change on screen as a blank cell.
