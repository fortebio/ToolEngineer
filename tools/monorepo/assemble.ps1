...
.SYNOPSIS
  ...
  scaffold Production), GIU LICH SU bang git subtree. Chay cuc bo, KHONG push.
...
if ($dirtyB -and -not $haveB) { Say "CANH BAO: repo B co thay doi chua commit - se KHONG vao monorepo (subtree lay commit):`n$($dirtyB -join "`n")" "Yellow" }
