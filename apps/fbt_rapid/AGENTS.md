...
sổ ra PNG. Vd `& .Codex\skills\run-fbt-rapid\driver.ps1` (launch Debug → chụp `_smoke.png` →
...
- **Tự cập nhật doc**: `.Codex/settings.json` có **Stop hook** nhắc bổ sung bài học mới vào AGENTS.md sau
