...
```powershell
& .Codex\skills\run-fbt-rapid\driver.ps1
```
...
& .Codex\skills\run-fbt-rapid\driver.ps1 -KeepOpen -Out shot.png
...
& .Codex\skills\run-fbt-rapid\driver.ps1 -Attach -Out after.png

# Screenshot the Release build instead of Debug
& .Codex\skills\run-fbt-rapid\driver.ps1 -Release
```
